...
const Sidebar = ({ selectedTab, setSelectedTab }) => {
  ...
  return (
    <>
       ...
       <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark openbtn" onClick={toggleSidebar}>{open ? <h4>Close Sidebar</h4> : <h4> Sidebar</h4> }</div>
      ...
      {open && (
              ...
              <ul className="nav nav-pills flex-column mb-auto">
                ...
                <li  onClick={() => handleOnClick('Followers')}>
                  <a href="#" className={`nav-link  text-white ${selectedTab === 'Followers' && 'active'}`}  >
                    <svg className="bi pe-none me-2" width="16" height="16"><use xlinkHref="#grid"></use></svg>
                    Followers
                  </a>
                </li>
                <li  onClick={() => handleOnClick('Setting')}>
                  <a href="#" className={`nav-link  text-white ${selectedTab === 'Setting' && 'active'}`}  >
